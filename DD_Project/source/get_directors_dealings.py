...
def get_single_directors_dealings(_data_location_insider_raw, _ticker):
    """
    ...
    if not exists(f):
        insider_data = pd.read_html(
            f'https://www.openinsider.com/screener?s={_ticker}&o=&pl=&ph=&ll=&lh=&fd=1461&fdr=&td=1461&tdr=&fdlyl=&fdlyh=&daysago=&xp=1&xs=1&vl=&vh=&ocl=&och=&sic1=-1&sicl=100&sich=9999&grp=0&nfl=&nfh=&nil=&nih=&nol=&noh=&v2l=&v2h=&oc2l=&oc2h=&sortcol=0&cnt=1000&page=1')
...
def get_all_directors_dealings(_data_location_insider_raw, _tickers):
    """
    ...
    for ticker in _tickers:
        ...
        get_single_directors_dealings(_data_location_insider_raw, ticker)
