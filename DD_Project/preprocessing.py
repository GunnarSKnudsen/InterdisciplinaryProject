...
AR_RESULTS_LOCATION = DATA_LOCATION + 'calculate_AR_results'
STATISTICAL_TESTS_LOCATION = DATA_LOCATION + 'statistical_tests'
VISUALISATIONS__LOCATION = DATA_LOCATION + 'visualisations'
RESULT_NOTEBOOKS_LOCATION = DATA_LOCATION + 'result_notebooks'
...
locations = [DATA_LOCATION, DATA_LOCATION_INSIDER_RAW, DATA_LOCATION_INSIDER_PROCESSED, DATA_LOCATION_TIME_SERIES_RAW,
             ...
             AR_RESULTS_LOCATION, STATISTICAL_TESTS_LOCATION, VISUALISATIONS__LOCATION, RESULT_NOTEBOOKS_LOCATION]
